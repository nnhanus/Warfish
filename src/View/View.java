...
public class View extends JFrame {
        ...
        public View() {
            ...
            try {/**Le chemin d'acces est spécifique à mon ordinateur et doit être changer si utiliser sur un autre pc*/
                meduse = ImageIO.read(new File("C:\\Users\\paulh\\IdeaProjects\\Warfish\\src\\cubomeduse.png"));
            } catch (IOException e) {
            }
           ...
           boutons.setBounds(100,200,200,100);
           cubomeduse.setBounds(0,0,400,HEIGHT_WIN/4);
